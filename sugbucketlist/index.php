...
?>
    ...
    <section>
      <div class="masthead__bg">
        <img src="img/masthead/1/bg.webp" alt="image" class="js-lazy">
      </div>
        ...
        <div class="row justify-center">
          <div class="col-auto">
            <div class="text-center">
              <h1 class="text-60 lg:text-40 md:text-30">“ I HAVEN’ T BEEN EVERYWHERE, BUT IT’S ON MY LIST.”</h1>
              <p class="mt-6 md:mt-10">– POPULAR TRAVEL QUOTE</p>
            </div>
                                ...
                                <div class="swiper-slide">
                                  ...
                                  <div class="table-calendar js-calendar-single">
                                    ...
                                    <div class="table-calendar__grid overflow-hidden">
                                      ...
                                      <div class="table-calendar__cell lh-1 text-light-1">
                                      ...
                                      <div  class="table-calendar__cell lh-1 ">
    ...
    <section class="layout-pt-lg layout-pb-md">
      <div class="container">
        ...
        <div class="relative pt-40 sm:pt-20 js-section-slider" >
          <div class="swiper-wrapper">
<!--destination loop here-->
            <div class="swiper-slide">

              <a href="#" class="citiesCard -type-1 d-block rounded-4 ">
                <div class="citiesCard__image ratio ratio-3:4">
                  <img src="img/cities/1/1.png"  alt="image" class="js-lazy">
                </div>
...
<!--end of distniantion loop-->
    ...
    <section class="layout-pt-md layout-pb-md">
      <div class="container">
        ...
        <div class="relative overflow-hidden pt-40 sm:pt-20 js-section-slider">
          <div class="swiper-wrapper">
                ...
                <div class="hotelsCard__image">
                  ...
                  <div class="cardImage ratio ratio-1:1">
                    <div class="cardImage__content">
                      ...
                      <img class="rounded-4 col-12 js-lazy" src="img/hotels/1.png" alt="image">
                    ...
                    <div class="cardImage__content">
                      ...
                      <div class="cardImage-slider rounded-4 overflow-hidden js-cardImage-slider">
                        <div class="swiper-wrapper">
                          ...
                          <div class="swiper-slide">
                            <img class="col-12 js-lazy" src="img/hotels/2.jpg" alt="image">
                          </div>

                          <div class="swiper-slide">
                            <img class="col-12 js-lazy" src="img/hotels/1.png" alt="image">
                          </div>
                ...
                <div class="hotelsCard__image">
                  ...
                  <div class="cardImage ratio ratio-1:1">
                    <div class="cardImage__content">
                      ...
                      <img class="rounded-4 col-12 js-lazy" src="img/hotels/2.jpg" alt="image">
      ...
      <div>
        <div class="row y-gap-20 justify-between">
          ...
          <div class="col-lg-3 col-sm-6">
            ...
            <div class="featureIcon -type-1 ">
              <div class="d-flex justify-center">
                <img src="img/featureIcons/1/1.svg" alt="image" class="js-lazy">
              </div>
          ...
          <div class="col-lg-3 col-sm-6">
            ...
            <div class="featureIcon -type-1 ">
              <div class="d-flex justify-center">
                <img src="img/featureIcons/1/2.svg" alt="image" class="js-lazy">
              </div>
          ...
          <div class="col-lg-3 col-sm-6">
            ...
            <div class="featureIcon -type-1 ">
              <div class="d-flex justify-center">
                <img src="img/featureIcons/1/3.svg" alt="image" class="js-lazy">
              </div>
    ...
    <section class="layout-pt-lg layout-pb-lg bg-blue-2">
      <div>
        <div class="row y-gap-40 justify-between">
          ...
          <div class="col-lg-6">
            <div class="overflow-hidden js-testimonials-slider-3">
              <div class="swiper-wrapper">

                <div class="swiper-slide">
                  <div class="row items-center x-gap-30 y-gap-20">
                    <div class="col-auto">
                      <img src="img/avatars/1.png" alt="image" class="js-lazy">
                    </div>
        ...
        <div class="row y-gap-30 pt-40">
            ...
            <a href="#" class="blogCard -type-1 d-block ">
              <div class="blogCard__image">
                <div class="ratio ratio-4:3 rounded-4 rounded-8">
                  <img class="img-ratio js-lazy" src="img/blog/1.png" alt="image">
                </div>
              </div>
          ...
          <div class="col-lg-4 col-sm-6">
            ...
            <a href="#" class="blogCard -type-1 d-block ">
              <div class="blogCard__image">
                <div class="ratio ratio-4:3 rounded-4 rounded-8">
                  <img class="img-ratio js-lazy" src="img/blog/2.png" alt="image">
                </div>
              </div>
      ...
      <div class="container">
        ...
        <div class="tabs -pills pt-40 js-tabs">
          <div class="tabs__controls d-flex js-tabs-controls">
            ...
            <div>
              <button class="tabs__button fw-500 text-15 px-30 py-15 rounded-4 js-tabs-button is-tab-el-active">Regions</button>
            </div>

            <div>
              <button class="tabs__button fw-500 text-15 px-30 py-15 rounded-4 js-tabs-button ">Cities</button>
            </div>

            <div>
              <button class="tabs__button fw-500 text-15 px-30 py-15 rounded-4 js-tabs-button ">Places of interest</button>
            </div>
...
?>
  ...
  <div class="currencyMenu is-hidden js-currencyMenu">
  ...
  <div class="mapFilter">
    ...
    <div class="mapFilter__close">
      <button class="button -blue-1 size-40 bg-white shadow-2">
        <i class="icon-close text-15"></i>
      </button>
    </div>

    <div class="mapFilter__grid">
      <div class="mapFilter-filter scroll-bar-1">
        <div class="px-20 py-20 md:px-15 md:py-15">
          <div class="d-flex items-center justify-between">
            ...
            <button class="size-40 flex-center rounded-full bg-blue-1">
