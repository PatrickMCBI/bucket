...
$tableName='file_uploaded_details'; // Enter your table Name;
...
if(isset($_POST['submit'])){
  ...
  function upload_files($tableName){
    ...
    $store="INSERT INTO `file_uploaded` (`user_id`,`title`,`description`) VALUES ('$user_id','$title','$description')";
    $exec= $db->query($store);
    ...
    function store_files($storeFilesBasename, $tableName){
      ...
      $value = trim($storeFilesBasename, ',');
       ...
       $store="INSERT INTO ".$tableName." (filename_uploaded, file_uploaded_id) VALUES".$value;
