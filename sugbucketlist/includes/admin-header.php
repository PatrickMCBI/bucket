...
<!-- Mirrored from creativelayers.net/themes/gotrip-html/db-settings.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 27 Jan 2023 10:10:06 GMT -->
...
<body data-barba="wrapper">
  ...
  <div class="preloader js-preloader">
    ...
    <div class="preloader__title">SUGBUCKETLIST</div>
  </div>
    ...
    <div data-anim="fade" class="header__container px-30 sm:px-20">
      <div class="-left-side">
        <a href="index.php" class="header-logo" data-x="header-logo" data-x-toggle="is-logo-dark">
          <img src="img/general/logo1.png" alt="logo icon" >
          <img src="img/general/logo1.png" alt="logo icon">
        </a>
      </div>
