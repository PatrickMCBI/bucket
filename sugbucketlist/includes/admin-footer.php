    ...
    <div class="footer__row row y-gap-10 items-center justify-between">
        <div class="col-auto">
            <div class="row y-gap-20 items-center">
                <div class="col-auto">
                    <div class="text-14 lh-14 mr-30">© 2023 SUGBUCKETLIST LLC All rights reserved.</div>
                </div>
        ...
        <div class="col-auto">
            <div class="d-flex x-gap-5 y-gap-5 items-center">
                <button class="text-14 fw-500 underline">English PH</button>
                <button class="text-14 fw-500 underline">Pesos</button>
            </div>
        </div>
    </div>
</footer>